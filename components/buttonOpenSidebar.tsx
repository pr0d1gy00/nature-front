...
export default function ButtonOpenSidebar({ setShowSidebar }: ButtonOpenSidebarProps) {
	return (
		<button title='menu' type='button' className='bg-[#35384b] rounded-full absolute top-[3%] left-[3%] p-2 hover:bg-[#7ed957] transition-colors w-14 h-14 flex items-center justify-center' onClick={()=>setShowSidebar(true)}>
