...
export default function Page() {
	const { handleChange, handleSubmit, email, loading } =
				...
				>
					...
					>
						...
						<h4 className="text-md text-[#35384b]">
							Luego de enviar la solicitud, recibirás un
							correo con instrucciones para restablecer
							tu contraseña.
						</h4>
					</motion.div>
					...
					>
						...
						>
							<Link
								href="/auth"
								className="text-2xl font-bold text-[#7ed957] text-center"
							>
								Vuelve a{" "}
								<span className="text-[#35384b]">
									Login
								</span>
							</Link>
						</motion.div>
